  ...
  return (
    <div className="custom-carousel-container">
      <div className="promo-banner">
        ...
        <p>10% скидка на весь асортимент товаров при вводе промокода «SALE10» в корзине</p>
        <a href="/catalog" className="catalog-link">КАТАЛОГ ТОВАРОВ →</a>
      </div>
